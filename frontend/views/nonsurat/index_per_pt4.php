...
<div class="arsip-index">
    ...
    <?= Html::a('<i class="fa glyphicon glyphicon-print"></i> Laporan', ['/nonsurat/mpdf1?' . 'NonsuratSearch[no_surat]=' . $_GET['NonsuratSearch']['no_surat'] .                                                                           '&NonsuratSearch[divisi_id]=' . $_GET['NonsuratSearch']['divisi_id'] .                                                                         '&NonsuratSearch[tema_id]=' . $_GET['NonsuratSearch']['tema_id'] .
